package com.example.camjob.security.handler;
...
public class OAuth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
        ...
        if (userOptional.isPresent()) {
            ...
            redirectURL = "http://campjob.netlify.app/oauth/callback.html?token=" + token + "&isNew=false";
        } else {
            ...
            redirectURL = "http://campjob.netlify.app/oauth/callback.html?email=" + emailEncoded + "&nickname=" + nicknameEncoded + "&isNew=true";
        }
